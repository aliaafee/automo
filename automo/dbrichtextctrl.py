...
class DbRichTextCtrl(wx.Panel):
    ...
    def __init__(self, parent, session, **kwds):
        ...
        self.toolbar.AddLabelTool(wx.ID_CUT, "Cut", images.get("cut"), wx.NullBitmap, wx.ITEM_NORMAL, "Cut selection", "")
        self.toolbar.AddLabelTool(wx.ID_COPY, "Copy", images.get("copy"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.toolbar.AddLabelTool(wx.ID_PASTE, "Paste", images.get("paste"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.toolbar.AddSeparator()
        self.toolbar.AddLabelTool(wx.ID_UNDO, "Undo", images.get("undo"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.toolbar.AddLabelTool(wx.ID_REDO, "Redo", images.get("redo"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.toolbar.AddSeparator()
        self.toolbar.AddLabelTool(wx.ID_BOLD, "Bold", images.get("bold"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.toolbar.AddLabelTool(wx.ID_ITALIC, "Italic", images.get("italic"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.toolbar.AddLabelTool(wx.ID_UNDERLINE, "Underline", images.get("underline"), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
